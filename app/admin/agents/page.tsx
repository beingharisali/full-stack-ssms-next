...
export default function AdminAgents() {
  ...
  const loadAgents = async () => {
    try {
      ...
      const agentUsers = (response.users || []).filter(
        (user: UserSummary) => user.role === "agent"
      );
          ...
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-gray-600 text-sm mt-1'>
                Manage support agents and their accounts
              </p>
            </div>
            <Link
                    ...
                    <tr
                      ...
                      <td className='px-6 py-4 whitespace-nowrap'>
                        <div className='flex items-center'>
                          <div className='h-10 w-10 rounded-full bg-linear-to-r from-blue-400 to-purple-500 flex items-center justify-center'>
          ...
          <div className='bg-white rounded-xl p-6 max-w-md w-full mx-4'>
            <div className='text-center'>
              ...
              <p className='text-gray-600 mb-6'>
                Are you sure you want to delete "{deleteModal.agent?.firstName}{" "}
                {deleteModal.agent?.lastName}"? This action cannot be undone.
              </p>
