...
export function TicketFiltersForm({ filters, onChange }: TicketFiltersProps) {
  ...
  return (
    <div className="flex gap-20 justify-center ">
      <div>
        <label className="block text-sm text-gray-800 ">Search</label>
        <input
      ...
      <div>
        ...
        <select
          className="border rounded px-4 py-2 text-sm mt-2"
      ...
      <div>
        <label className="block text-sm text-gray-800">Priority</label>
        <select
          className="border rounded px-4 py-2 text-sm mt-2"
      ...
      <div>
        <label className="block text-sm text-gray-800 ">Sort</label>
        <select
          className="border rounded px-4 py-2 text-sm mt-2"
